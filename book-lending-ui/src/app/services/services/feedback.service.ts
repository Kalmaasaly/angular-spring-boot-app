...
import { findFeedbacks } from '../fn/feedback/find-feedbacks';
import { FindFeedbacks$Params } from '../fn/feedback/find-feedbacks';
...
export class FeedbackService extends BaseService {
  ...
  static readonly SaveFeedbackPath = '/saveFeedback';

  /**
   * Insert a new saveFeedback.
   *
   *
   *
  ...
  static readonly FindFeedbacksPath = '/book/{book-id}';
   ...
   */
  findFeedbacks$Response(params: FindFeedbacks$Params, context?: HttpContext): Observable<StrictHttpResponse<PageResponseFeedbackResponse>> {
    return findFeedbacks(this.http, this.rootUrl, params, context);
  }
   ...
   * This method doesn't expect any request body.
   */
  findFeedbacks(params: FindFeedbacks$Params, context?: HttpContext): Observable<PageResponseFeedbackResponse> {
    return this.findFeedbacks$Response(params, context).pipe(
